...
import me.woojeeyoung.springbootdeveloper.dto.ArticleResponse;
...
public class BlogApiController {
    ...
    public ResponseEntity<Article> addArticle(@RequestBody @Validated
                                AddArticleRequest request, Principal principal) {
    ...
    public ResponseEntity<List<ArticleResponse>> finaAllArticles() {
